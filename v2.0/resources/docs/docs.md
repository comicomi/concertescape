...
* Update the connection parameters for the database in the `concertesc.db.core` namespace of your application.
...
Request middleware functions are located under the `concertesc.middleware` namespace.
